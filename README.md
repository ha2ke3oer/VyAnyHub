...
local Window = Flux:Window("Vyan script  ", "Working-modifiers", Color3.new(0,0.8), Enum.KeyCode.RightControl)
local Tab = Window:Tab("Game", "rbxassetid://6026568198")
...
local ESP_Entities = {RushMoving={"Rush",10},AmbushMoving={"Ambush",10},FigureRagdoll={"Figure",7},FigureLibrary={"Figure",7},SeekMoving={"Seek",10},Screech={"Screech",2},Eyes={"Eyes",4},Snare={"Snare",2},A60={"A-60",10},A120={"A-120",10}}
local ESP_Other = {Door={"Door",10},LeverForGate={"Lever",5},GoldPile={"Gold",0.5},Bandage={"Bandage",0.5}}
...
if Floor.Value == "Hotel" or Floor.Value == "Fools" then
    Tab:Button("Auto open door 51","Instantly inputs the Padlock code for Room 50. Can guess up to 3 digits. Requires 1 Player to have the hint paper.",function()
