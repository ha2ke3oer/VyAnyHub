...
local Window = Flux:Window("Vyany ", "no hub", Color3.new(0,0.8), Enum.KeyCode.RightControl)
...
local ESP_Entities = {RushMoving={"Rush",10},AmbushMoving={"Ambush",10},FigureRagdoll={"Figure",7},FigureLibrary={"Figure",7},SeekMoving={"Seek",5.5},Screech={"Screech",2},Eyes={"Eyes",4},Snare={"Snare",2},A60={"A-60",10},A120={"A-120",10}}
local ESP_Other = {Door={"Door",8},LeverForGate={"Lever",3},GoldPile={"Gold",0.5},Bandage={"Bandage",0.5}}
...
if Floor.Value == "Hotel" or Floor.Value == "Fools" then
    ...
    Tab:Toggle("no Seek","Makes it so you can't trigger Seek to spawn. Other players still can.",false,function(Bool)
        DisableSeek = Bool
        for _,Object in pairs(workspace.CurrentRooms:GetDescendants()) do
